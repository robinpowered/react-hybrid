...
var react_2 = require("@uirouter/react");
 ...
 */
function UIRouterContextComponent(props) {
    var parentContextLevel = props.parentContextLevel, inherited = props.inherited, children = props.children;
    var _a = react_1.useState(initialState), contextFromAngularJS = _a[0], setContextFromAngularJS = _a[1];
    var routerFromReactContext = react_1.useContext(react_2.UIRouterContext);
    var parentUIViewFromReactContext = react_1.useContext(react_2.UIViewContext);
    ...
    return (React.createElement(react_2.UIRouterContext.Provider, { value: (inherited && routerFromReactContext) || contextFromAngularJS.router },
        React.createElement(react_2.UIViewContext.Provider, { value: (inherited && parentUIViewFromReactContext) || contextFromAngularJS.addr }, childrenCount === 1 ? React.Children.only(children) : React.createElement("div", null, children))));
}
