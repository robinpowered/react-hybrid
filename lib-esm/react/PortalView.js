...
var PortalView = /** @class */ (function(_super) {
  ...
  function PortalView() {
    ...
    _this.debug = function(method, message) {
      ...
      return debugLog.apply(
        void 0,
        ['react', 'PortalView', _this.$id + '/' + _this.props['name'], method, message].concat(args)
      );
    };
    _this.createPortalToChildUIView = function(uiViewId, childUIView) {
      _this.debug(
        '.createPortalToChildUIView()',
        JSON.stringify(childUIView.childUIViewProps),
        childUIView.portalTarget
      );
      _this.setState(function(prev) {
        var _a;
        var portals = __assign({}, prev.portals, ((_a = {}), (_a[uiViewId] = childUIView), _a));
    ...
    _this.removePortalToChildUIView = function(uiViewId) {
      ...
      _this.debug(
        '.removePortalToChildUIView()',
        '' + uiViewId,
        childUIView.childUIViewProps,
        childUIView.portalTarget
      );
      _this.setState(function(prev) {
  ...
  PortalView.prototype.renderPortals = function() {
    ...
    return Object.keys(portals).map(function(key) {
      ...
      return React.createElement(
        'div',
        { style: { display: 'none' }, key: '' + key },
        ReactDOM.createPortal(
          React.createElement(ReactUIView, __assign({}, portal.childUIViewProps)),
          portal.portalTarget
        )
      );
    });
  ...
  PortalView.prototype.render = function() {
    ...
    return React.createElement(
      React.Fragment,
      null,
      React.createElement(AngularUIView, __assign({}, this.props, { portalView: this })),
      this.renderPortals()
    );
  };
  return PortalView;
